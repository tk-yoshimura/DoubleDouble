    ...
    public partial struct ddouble {
        ...
        internal static partial class Consts {
            ...
            public static class Erfc {
                public static ReadOnlyCollection<(ddouble c, ddouble d)> GtP5PadeTable = new(new (ddouble c, ddouble d)[]{
                ...
                public static ReadOnlyCollection<(ddouble c, ddouble d)> Gt1PadeTable = new(new (ddouble c, ddouble d)[]{
                ...
                public static ReadOnlyCollection<(ddouble c, ddouble d)> Gt2PadeTable = new(new (ddouble c, ddouble d)[]{
                ...
                public static ReadOnlyCollection<(ddouble c, ddouble d)> Gt4PadeTable = new(new (ddouble c, ddouble d)[]{
                ...
                public static ReadOnlyCollection<(ddouble c, ddouble d)> Gt8PadeTable = new(new (ddouble c, ddouble d)[]{
                ...
                public static ReadOnlyCollection<(ddouble c, ddouble d)> Gt16PadeTable = new(new (ddouble c, ddouble d)[]{
