    ...
    public partial struct ddouble {
        ...
        internal static partial class Consts {
            public static class StieltjesGamma {
                public static readonly ReadOnlyCollection<ddouble> StieltjesGammaTable = GenerateStieltjesGammaTable();

                public static ReadOnlyCollection<ddouble> GenerateStieltjesGammaTable() {
