...
namespace DoubleDoubleNumTablePacking {
    public static class ErfcTable {
        public static void Pack(BinaryWriter stream) {
            Dictionary<string, ReadOnlyCollection<(Hexcode c, Hexcode d)>> tables = new(){
                { nameof(GtP5PadeTable), GtP5PadeTable },
                { nameof(Gt1PadeTable), Gt1PadeTable },
                { nameof(Gt2PadeTable), Gt2PadeTable },
                { nameof(Gt4PadeTable), Gt4PadeTable },
                { nameof(Gt8PadeTable), Gt8PadeTable },
                { nameof(Gt16PadeTable), Gt16PadeTable },
            };
        ...
        public static readonly ReadOnlyCollection<(Hexcode c, Hexcode d)> Gt16PadeTable = new(new (Hexcode c, Hexcode d)[]{
            ...
            (Hexcode.Zero, (+1, -45, 0xF283DE11BF2C2226uL, 0x294285FDBDCD1505uL)),
        });
    }
}
