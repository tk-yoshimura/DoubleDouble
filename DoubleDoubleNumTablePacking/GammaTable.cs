...
namespace DoubleDoubleNumTablePacking {
    public static class GammaTable {
        ...
        static readonly ReadOnlyCollection<(Hexcode c, Hexcode d)> PadeX0p5Table = new(new (Hexcode c, Hexcode d)[] {
            ...
            ((+1, 0, 0xF2742C50BFB72E81uL, 0x6295F2EB5527821BuL), (+1, 1, 0xC20F41B2D111AA43uL, 0x643CA1316C4CDF62uL)),
            ((+1, 0, 0x85D8AAC20B1E212BuL, 0x1427D484CA68EE8BuL), (+1, 1, 0x89827FA6E24E0F61uL, 0xBAAD0749A8EE7917uL)),
            ((+1, -2, 0xCE1471A6835B2369uL, 0x9FF412777FC6C324uL), (+1, -6, 0xF918D47888092E14uL, 0xB6078A498A83B2D6uL)),
            ((+1, -4, 0xEF4A7423E8E569B5uL, 0x57CAF974EBECD7C1uL), (-1, -2, 0x90CCA8A355891303uL, 0xF5F652EC9A7415CCuL)),
            ((+1, -6, 0xDFDF61529560ED60uL, 0x91461436540F2648uL), (-1, -8, 0x8153CE1DDA62B80AuL, 0x9B0591A7C8827842uL)),
            ((+1, -8, 0xAA28681B6D243ADFuL, 0x1CC0DD4C9996434AuL), (+1, -6, 0x96A94355E8E54405uL, 0x4AD96C49DE84DDD6uL)),
            ((+1, -11, 0xD87C193CC8413254uL, 0x07111EEFAB880BA9uL), (-1, -10, 0xB8044BCA15870AA8uL, 0x634109CED596089BuL)),
            ((+1, -14, 0xDF5168CB7AD96B09uL, 0x529914CE602899E7uL), (-1, -12, 0xEDA10B35503107E4uL, 0x31934665738833ADuL)),
            ((+1, -17, 0xBF54086BD2B66444uL, 0x463822F463A9A183uL), (+1, -14, 0xB2B1531F344A0DD2uL, 0x43F8F61146432DEEuL)),
            ((+1, -21, 0xEB351F4FA4B48402uL, 0x5514D88A04BC4C48uL), (-1, -18, 0x92F540DCA5319EEFuL, 0x3ED00B9562D3299EuL)),
            ((+1, -25, 0xE0ED0C9CBEF067E9uL, 0x8ECE651D7FE5F959uL), Hexcode.Zero),
        });
        ...
        static readonly ReadOnlyCollection<(Hexcode c, Hexcode d)> PadeX1p5Table = new(new (Hexcode c, Hexcode d)[] {
            ...
            ((+1, -1, 0xB3E87107BFE9AD75uL, 0xF66CDFD1965AF5EEuL), (+1, -1, 0xC1A9B8E195824DFEuL, 0xE8A318BFE6E2511AuL)),
            ((+1, -2, 0xA81F401C3BD78D5CuL, 0xEA3F478747C8D186uL), (-1, -3, 0x80281741C2EAC1A7uL, 0x6FFD6D0F9908FC6CuL)),
            ((+1, -4, 0xD7C4FAB2D5AB7FBEuL, 0xE725D2B0FB372774uL), (-1, -4, 0xE067C7AAC0C2BA89uL, 0x9668EDC2983D84C4uL)),
            ((+1, -6, 0xD553F552A1640D3BuL, 0xAF9787C612426FD6uL), (+1, -6, 0xA6979AA61D8FAD2CuL, 0xB14FB3C11A663DA3uL)),
            ((+1, -8, 0xA5C6BF9C4A7C3BB1uL, 0xFB2AA58A4D123258uL), (+1, -8, 0xA74F09E4953A14D0uL, 0xEEC902DA270DDD9BuL)),
            ((+1, -11, 0xD1921FA3012FF822uL, 0x13FC7A0F731CF5A6uL), (-1, -10, 0xD1F2B74AA69E43EAuL, 0x0DA46BE5D526BF6DuL)),
            ((+1, -14, 0xD2CA8AC577D82FB0uL, 0xE3D83582300022EEuL), (+1, -16, 0xFD08128606E6297BuL, 0xB540C5C009BE5992uL)),
            ((+1, -17, 0xA9B66641BA92D392uL, 0xA5813A4D3C80CF5DuL), (+1, -15, 0x94C842BC7AAB5433uL, 0xB816F8ED638F3D98uL)),
            ((+1, -21, 0xC2E7440E88C26CE0uL, 0x0635571CE2AA4613uL), (-1, -18, 0xA5E56B8D4CB6C10FuL, 0xF8C99A65D58114D3uL)),
            ((+1, -25, 0x9A1AB8B8E19294C6uL, 0x7D15211EB53BB896uL), (+1, -23, 0xEB81298E108153FAuL, 0x5FBBB2D6CDC4FAFEuL)),
        });
        static readonly ReadOnlyCollection<(Hexcode c, Hexcode d)> PadeX2p0Table = new(new (Hexcode c, Hexcode d)[] {
            ((+1, 0, 0x8000000000000000uL, 0x0000000000000000uL), (+1, 0, 0x8000000000000000uL, 0x0000000000000000uL)),
            ((+1, -1, 0xCA85E03BE130D372uL, 0x92D3D78336857010uL), (+1, -2, 0xBC94903EBDC3362EuL, 0xC9242E087AD768EEuL)),
            ((+1, -2, 0xBF34AE24BE22D41CuL, 0xFD23E0C127AA84D8uL), (-1, -3, 0xC6C542B9C8741E1BuL, 0x2F08B87601EFE432uL)),
            ((+1, -4, 0xF75C025FFC5263CFuL, 0x7E5A792EA8C93011uL), (-1, -6, 0xF92F01CF524B002DuL, 0xA99D1D093EA1672FuL)),
            ((+1, -6, 0xF7933A0DB600DCDFuL, 0x0EA637389C2F569AuL), (+1, -6, 0x996E5F0A6CE6F39AuL, 0xFAAD02F650793C6DuL)),
            ((+1, -8, 0xC26F70CD4AC22A41uL, 0x530D322E065F2BF9uL), (-1, -11, 0xB8432E2A97F90EE4uL, 0x4F7C6A80B7BDC7C1uL)),
            ((+1, -11, 0xF98264D2FF6328CBuL, 0xB7AD60879D8B9B5CuL), (-1, -11, 0xA429CC1898F8FB03uL, 0xF2C0172D0D57D5B6uL)),
            ((+1, -14, 0xFE26A586F184587BuL, 0x27E049892B25792AuL), (+1, -14, 0xCEC8E8C67E0597F1uL, 0xE8D0870D0D07C10FuL)),
            ((+1, -17, 0xD119B217BE0696C4uL, 0x0BBC3AF366D0DB46uL), (-1, -21, 0xE332FF4B0BD97E58uL, 0xF7BC77A336CD6DC8uL)),
            ((+1, -21, 0xF3BBE53F889798C2uL, 0x028CAD0454B93344uL), (-1, -21, 0xE8113131FB17BDBAuL, 0x90CA9F3D8FD90F4BuL)),
            ((+1, -25, 0xCB4B1B5D63544CBCuL, 0x54B54ED08EC3110FuL), (+1, -25, 0xEE7A4EF0AB458BDCuL, 0xF6E07B0CBDD34C50uL)),
        });
