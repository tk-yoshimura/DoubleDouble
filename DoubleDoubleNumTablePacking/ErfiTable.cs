...
namespace DoubleDoubleNumTablePacking {
    public static class ErfiTable {
        ...
        public static readonly ReadOnlyCollection<(Hexcode c, Hexcode d)> PadeX0p5Table
        ...
        public static readonly ReadOnlyCollection<(Hexcode c, Hexcode d)> PadeX1p5Table
            = new(new (Hexcode c, Hexcode d)[] {
        ...
        public static readonly ReadOnlyCollection<(Hexcode c, Hexcode d)> PadeX2p5Table
            = new(new (Hexcode c, Hexcode d)[] {
        ...
        public static readonly ReadOnlyCollection<(Hexcode c, Hexcode d)> PadeX3p5Table
            = new(new (Hexcode c, Hexcode d)[] {
