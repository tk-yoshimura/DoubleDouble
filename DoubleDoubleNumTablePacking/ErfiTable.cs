...
namespace DoubleDoubleNumTablePacking {
    public static class ErfiTable {
        ...
        static readonly ReadOnlyCollection<(Hexcode c, Hexcode d)> PadeX1p5Table
            = new(new (Hexcode c, Hexcode d)[] {
        ...
        static readonly ReadOnlyCollection<(Hexcode c, Hexcode d)> PadeX2p5Table
            = new(new (Hexcode c, Hexcode d)[] {
        ...
        static readonly ReadOnlyCollection<(Hexcode c, Hexcode d)> PadeX3p5Table
            = new(new (Hexcode c, Hexcode d)[] {
