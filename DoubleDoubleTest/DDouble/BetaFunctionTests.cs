...
namespace DoubleDoubleTest.DDouble {
    ...
    public class BetaFunctionTests {
        ...
        public void IncompleteBetaTest() {
            ddouble.IncompleteBeta(5 / 8d, 357d / 32, 1);
            ...
            for (ddouble b = 1d / 32; b <= 32; b *= 2) {
                for (ddouble a = 1d / 32; a <= 32; a *= 2) {
                    ...
                    for (ddouble x = 0; x <= 1; x += 1d / 8) {
                        ...
                        HPAssert.AreEqual(g, (a * f - p) / (a + b), g * 1e-28, $"beta({x},{a},{b})");
                        HPAssert.AreEqual(h, (b * f + p) / (a + b), h * 1e-28, $"beta({x},{a},{b})");
                    }
                }
            }

            for (ddouble a = 1d / 4; a <= 4; a += 1d / 4) {
                for (ddouble x = 1d / 16; x <= 1; x += 1d / 16) {
                    ...
                    HPAssert.AreEqual(v, y, v * 1e-29, $"beta({x},{a},1)");
                }
            }

            for (ddouble b = 1d / 4; b <= 4; b += 1d / 4) {
                for (ddouble x = 1d / 16; x <= 1; x += 1d / 16) {
                    ...
                    HPAssert.AreEqual(v, y, v * 1e-29, $"beta({x},1,{b})");
                }
            }
